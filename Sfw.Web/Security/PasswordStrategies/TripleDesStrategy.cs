...
namespace Sfw.Web.Security.PasswordStrategies
{
    /// <summary>
    ...
    public class TripleDesStrategy : IPasswordStrategy
    {
        ...
        public static string EncryptString(string password, string passphrase)
        {
            ...
            var cryptoServiceProvider = new TripleDESCryptoServiceProvider { Key = key, Mode = CipherMode.ECB, Padding = PaddingMode.PKCS7 };
